...
- **Corpus**: 58 accept / 48 reject fixtures in `tests/programs/` (see `tests/programs/README.md`), 535 tests green, with a drift-monitoring baseline against bpf-next 7.2.0-rc6 (`tools/drift-baseline/`, `src/bin/drift.rs --record/--compare`).
